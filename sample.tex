...
In our previous study, inspired by the trimeric spike proteins in coronaviruses, the authors developed a simple liquid model to investigate how monomers self-organize into dimers, trimers, and tetramers on spherical surfaces. The simulations, performed using Monte Carlo methods with Yukawa potentials incorporating both radial and angular dependencies, showed that trimers are easier to form and more stable than dimers, while tetramers require stronger attractive forces and are prone to aggregation. Analyses of energy and entropy contributions revealed that trimers are generally more stable than dimers and, under certain conditions, comparable to tetramers.we developed a simple yet insightful model to understand how monomers can self-organize into trimers and tetramers on spherical surfaces. Our findings show that trimers are easier to form and more stable than dimers, and in many conditions, they are as stable—or even more stable—than tetramers. Tetramers require stronger attractive forces to form and are more prone to aggregation when these forces become too strong. These results highlight the importance of both energetic and entropic contributions to self-organization, particularly how interaction geometry and asymmetry influence the outcome.
...
We have successfully simulated the membrane and the spike protein on its outer surface. Now, we are shifting our project focus from the outside of the membrane to the inside, concentrating on the interactions between the membrane and the genome within it.
