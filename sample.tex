...
\begin{figure}[!ht]
  \centering  
  \fbox{\includegraphics[width=0.4\textwidth,height=4.5cm]{fusion.png}}
  \caption{Membrane fusion. Many viruses, both enveloped and unenveloped, are
brought into cells by endocytosis. The low pH environment in the
endosome triggers molecular rearrangements of capsid or envelope
proteins. In this example an enveloped virus is fusing with an endo-
somal membrane to release the capsid into the cytoso\cite{payne2022viruses}.}
\end{figure}
\end{comment}
