...
Even in their three-dimensional structures, DNA and RNA still retain key polymer-like behaviors. Like synthetic polymers, they adopt a wide range of conformations driven by thermal fluctuations, flexibility, and chain connectivity. Their ability to bend, loop, and coil in 3D is governed by the same physical principles that describe polymer chains in solution. For example, the coiling of single-stranded RNA or the supercoiling of DNA can be explained using models like the worm-like chain or bead-spring representations. Thus, despite their biological complexity, DNA and RNA are fundamentally polymers in both structure and behavior, even in their folded, 3D forms.\\

Their shape and behavior depend on the nucleotide sequence, chemical interactions, and environmental conditions. They also interact with proteins, which is important for processes like gene expression and viral assembly. Because of these polymer-like properties, we can use polymer models to study and simulate how DNA and RNA behave.\\
...
Even in their three-dimensional conformations, DNA and RNA retain the fundamental characteristics of polymers. Like synthetic polymer chains, they exhibit a wide range of configurations driven by thermal fluctuations, chain connectivity, and molecular flexibility. Their ability to bend, coil, loop, and supercoil in 3D can be effectively described using physical models such as the worm-like chain or bead-spring representations. A widely used example is the “bead-on-a-string” model, where each bead represents a segment of DNA or a nucleosome. These models allow researchers to simulate how DNA folds, loops, and compacts within the spatial constraints of the nucleus, and have significantly advanced our understanding of genome organization in interphase nuclei \cite{Lizana2024}.

Despite their biological complexity and sequence-specific interactions, DNA and RNA behave in ways consistent with polymer physics. Their structure and dynamics are influenced by nucleotide sequence, chemical environment, and interactions with proteins—factors crucial to gene regulation, genome packaging, and viral assembly. Because of their polymer-like nature, coarse-grained models rooted in polymer theory provide a powerful framework for studying and simulating DNA and RNA behavior.
...
Using MC with CG models is particularly useful for studying large-scale behaviors like polymer folding, self-assembly, phase transitions, or how polymers interact with other surfaces or structures. Since we don’t need to worry about every atomic detail, we can focus on understanding the broader behavior of the material. For instance, in a coarse-grain polymer simulation, MC methods might rotate parts of the polymer chain, stretch or shift segments, or rearrange them—checking each time how these changes affect the system’s overall energy or structure.\\
