...
\begin{align}
F_\text{full} = \int_S \Bigg[
&\underbrace{\frac{\kappa}{2} \left(2H - C_0 \right)^2}_{(1)\ \text{spontaneous-curvature-modified bending}} 
\ + \ 
